...
**Launchpad** is a self-hosted web launcher — a browser homepage for organizing URLs into a drag-and-drop grid with auto-fetched favicons. Monorepo with a React/Vite frontend and Express/TypeScript backend.
