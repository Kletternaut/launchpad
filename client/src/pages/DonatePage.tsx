  ...
  return (
    <div className="min-h-full">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="text-2xl font-extrabold tracking-tight text-text">Support Launchpad</h1>
        ...
        <Surface className="p-6 mb-5">
          ...
          <p className="text-xs mb-5 text-text2">
            Launchpad is and always will be free, open source, and self-hosted.
          </p>
        ...
        <Surface className="p-6">
          ...
          <p className="text-xs m-0 text-text2">
            Every bit of support helps keep Launchpad free for everyone.
          </p>
        </Surface>
      </div>
    </div>
